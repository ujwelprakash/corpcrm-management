...
const labelCls =
  "block text-[11.5px] font-semibold mb-1 text-[rgb(var(--color-text-soft))]";
    ...
    mutate(
      {
        ...
        location: "",
        manager: "",
        startDate: data.companyJoiningDate,
        status: "active",
      },
      {
        onSuccess: () => {
    ...
    >
      <div className="mb-5">
        ...
        >
          ...
          <span>›</span>
          <span style={{ color: `rgb(var(--color-text-soft))` }}>
            {t("createEmployee")}
          </span>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <input
                    ...
                    ref={(e) => {
                      fileRegRef(e);
                      (
                        fileRef as React.MutableRefObject<HTMLInputElement | null>
                      ).current = e;
                    }}
                    type="file"
          ...
          <div className="flex flex-col gap-4">
            <Section title={t("companyDetail")}>
              ...
              <Field
                label={t("joiningDate")}
                error={errors.companyJoiningDate?.message}
              >
                <input
                  {...register("companyJoiningDate")}
                  type="date"
                  className={inputCls(!!errors.companyJoiningDate)}
                />
              </Field>
            </Section>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <input
                    ...
                    className={inputCls(!!errors.bankIdentifierCode)}
                  />
                </Field>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <input
                    ...
                    className={inputCls(!!errors.branchLocation)}
                  />
                </Field>
                ...
                >
                  <input
                    ...
                    className={inputCls(!!errors.taxPayerId)}
                  />
                </Field>
              </div>
            </Section>
